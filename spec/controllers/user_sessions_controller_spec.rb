...
describe UserSessionsController do
  ...
  describe "POST 'create'" do
    context "with correct credentials" do
      let!(:user) { User.create(first_name: "Chad", last_name: "Flores", email: "chadwickflores@gmail.com", password: "treehouse1", password_confirmation: "treehouse1") }
      
      it "redirects to the todo list path" do
        post :create, email: "chadwickflores@gmail.com", password: "treehouse1"
        expect(response).to be_redirect
        expect(response).to redirect_to(todo_lists_path)
      end

      it "finds the user" do
        expect(User).to receive(:find_by).with({email: "chadwickflores@gmail.com"}).and_return(user)
        post :create, email: "chadwickflores@gmail.com", password: "treehouse1"
      end
      ...
      it "sets the remember_me_token cookie if chosen" do
        ...
        post :create, email: "chadwickflores@gmail.com", password: "treehouse1", remember_me: "1"
